...
// Define the hardware serial port for Bluetooth communication
HardwareSerial Bluetooth(1); // Use Serial1 for ESP32 Bluetooth communication
...
void setup() {
  ...
  Serial.begin(38400);
  Bluetooth.begin(38400, SERIAL_8N1, 16, 17); // RX=16, TX=17 (adjust pins as needed)
